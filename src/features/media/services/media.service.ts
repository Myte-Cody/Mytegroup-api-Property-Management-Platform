...
export class MediaService implements MediaServiceInterface {
  ...
  async upload(
    ...
    let determinedEntityType = entityType || entity?.constructor?.name || entity.model_type || 'UnknownModel';
    if (determinedEntityType === 'MongoTenantModel' || determinedEntityType === 'model' || determinedEntityType === 'Object') {
